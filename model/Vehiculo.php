...
class Vehiculo{
    ...
    public function __toString() {
        return "Matricula: ".$this->matricula.", Marca: ".$this->marca.", Modelo: ".$this->modelo.", Color: ".$this->color."Plazas: ".$this->plazas.", Fecha ultma revision: ".$this->fecha_ultima_revision;
    }
